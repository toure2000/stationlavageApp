...
@Component({
  selector: 'app-formmodiftype-voiture',
  standalone: true,
  imports: [
    MatGridListModule,
    MatListModule,
  ...
  templateUrl: './formmodiftype-voiture.component.html',
  styleUrl: './formmodiftype-voiture.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class FormmodiftypeVoitureComponent {
  constructor(
  ...
  ngOnInit() {
    ...
    //pour formulaire
    //this.FormadtypeVoitureS.initFormModif(new Type_voiture())
  ...
  ngAfterViewInit() {
    ...
    let url0=this.FormadtypeVoitureS.url;
    if(url0){
      voitureimagefile.src=this.conns.GlobaleS.normaliseImage(url0)
    }
  }
